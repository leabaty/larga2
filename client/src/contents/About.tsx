...
const lang = new LocalizedStrings({
  en: {
    ...
    skipperTitle: 'Denis',
    skipperDesc: [
      'As a passionate sailor, with numerous regattas and nautical miles under his belt, Denis now sets sail on his Larga II almost daily since acquiring it five years ago.',
  ...
  fr: {
    ...
    skipperTitle: 'Denis',
    skipperDesc: [
      'Navigateur passionné, avec de nombreuses régates et milles à son actif, Denis hisse les voiles de son Larga II presque quotidiennement depuis son acquisition il y a cinq ans.',
